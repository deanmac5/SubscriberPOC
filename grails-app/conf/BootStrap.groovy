...
class BootStrap {
    ...
    private createSampleData(){
        ...
        def first = new User(username: "Pablo", password: 'password', email: "mediareleasetester@gmail.com", subscriptions: [Agency.findByTitle("Dept of Industry"), Agency.findByTitle("Dept of Finance")]).save()
        def second = new User(username: "Deano", password: 'password', email: "mediareleasetester@gmail.com", subscriptions: [Agency.findByTitle("Dept of Finance")]).save()
