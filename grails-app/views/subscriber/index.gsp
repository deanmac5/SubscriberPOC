		...
		<div id="list-subscriber" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="verified" title="${message(code: 'subscriber.verified.label', default: 'Verified')}" />
				...
				<g:each in="${subscriberInstanceList}" status="i" var="subscriberInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${subscriberInstance.id}">${fieldValue(bean: subscriberInstance, field: "email")}</g:link></td>
					
						<td><g:formatBoolean boolean="${subscriberInstance.verified}" /></td>
