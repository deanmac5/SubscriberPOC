	...
	<body>
		...
		<div id="show-subscriber" class="content scaffold-show" role="main">
			...
			<ol class="property-list subscriber">
				...
				<g:if test="${subscriberInstance?.verified}">
				<li class="fieldcontain">
					<span id="verified-label" class="property-label"><g:message code="subscriber.verified.label" default="Verified" /></span>
					
						<span class="property-value" aria-labelledby="verified-label"><g:formatBoolean boolean="${subscriberInstance?.verified}" /></span>
